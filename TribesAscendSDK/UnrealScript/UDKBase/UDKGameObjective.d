...
{
	public @property final auto ref ScriptArray!(NavigationPoint) ShootSpots() { return *cast(ScriptArray!(NavigationPoint)*)(cast(size_t)cast(void*)this + 692); }
	public @property final auto ref ubyte DefenderTeamIndex() { return *cast(ubyte*)(cast(size_t)cast(void*)this + 740); }
	public @property final auto ref UIRoot.TextureCoordinates IconCoords() { return *cast(UIRoot.TextureCoordinates*)(cast(size_t)cast(void*)this + 724); }
	public @property final auto ref Texture2D IconHudTexture() { return *cast(Texture2D*)(cast(size_t)cast(void*)this + 720); }
	public @property final auto ref Vector HUDLocation() { return *cast(Vector*)(cast(size_t)cast(void*)this + 708); }
	public @property final bool bUnderAttack() { return (*cast(uint*)(cast(size_t)cast(void*)this + 704) & 0x2) != 0; }
	public @property final bool bUnderAttack(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 704) |= 0x2; } else { *cast(uint*)(cast(size_t)cast(void*)this + 704) &= ~0x2; } return val; }
	public @property final bool bAllowOnlyShootable() { return (*cast(uint*)(cast(size_t)cast(void*)this + 704) & 0x1) != 0; }
	public @property final bool bAllowOnlyShootable(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 704) |= 0x1; } else { *cast(uint*)(cast(size_t)cast(void*)this + 704) &= ~0x1; } return val; }
	...
	final void DrawIcon(Canvas pCanvas, Vector IconLocation, float IconWidth, float IconAlpha, UDKPlayerController PlayerOwner, UObject.LinearColor DrawColor)
	{
		ubyte params[44];
		params[] = 0;
