...
extern(C++) interface UDKAnimBlendByWeapon : AnimNodeBlendPerBone
{
	...
	public @property final auto ref ScriptName LoopingAnim() { return *cast(ScriptName*)(cast(size_t)cast(void*)this + 304); }
	public @property final bool bLooping() { return (*cast(uint*)(cast(size_t)cast(void*)this + 300) & 0x1) != 0; }
	public @property final bool bLooping(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 300) |= 0x1; } else { *cast(uint*)(cast(size_t)cast(void*)this + 300) &= ~0x1; } return val; }
	final void AnimFire(ScriptName FireSequence, bool bAutoFire, float AnimRate, float SpecialBlendTime, ScriptName LoopSequence)
	{
		ubyte params[28];
		params[] = 0;
	...
	final void AnimStopFire(float SpecialBlendTime)
	{
		ubyte params[4];
		params[] = 0;
