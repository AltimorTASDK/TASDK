...
{
	public @property final auto ref float m_YouHaveTheFlagReminderTime() { return *cast(float*)(cast(size_t)cast(void*)this + 940); }
	public @property final auto ref int m_ReturnedTimeLimit() { return *cast(int*)(cast(size_t)cast(void*)this + 936); }
	public @property final auto ref int m_LastReturnedTime() { return *cast(int*)(cast(size_t)cast(void*)this + 932); }
	...
	final void RemindPlayerAboutFlagTimer()
	{
	...
	final void BroadcastCapturedMessage(Controller EventInstigator)
	{
		ubyte params[4];
		params[] = 0;
		*cast(Controller*)params.ptr = EventInstigator;
