...
extern(C++) interface TrMakeQuickMatch : UObject
{
	...
	public @property final bool bProcessingJoin() { return (*cast(uint*)(cast(size_t)cast(void*)this + 88) & 0x2) != 0; }
	public @property final bool bProcessingJoin(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 88) |= 0x2; } else { *cast(uint*)(cast(size_t)cast(void*)this + 88) &= ~0x2; } return val; }
	public @property final bool bIssuedInitialQuery() { return (*cast(uint*)(cast(size_t)cast(void*)this + 88) & 0x1) != 0; }
	public @property final bool bIssuedInitialQuery(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 88) |= 0x1; } else { *cast(uint*)(cast(size_t)cast(void*)this + 88) &= ~0x1; } return val; }
	public @property final auto ref TrGameSettingsCommon GameSettings() { return *cast(TrGameSettingsCommon*)(cast(size_t)cast(void*)this + 84); }
	public @property final auto ref TrGameSearchCommon SearchSettings() { return *cast(TrGameSearchCommon*)(cast(size_t)cast(void*)this + 80); }
	public @property final auto ref OnlineSubsystem OnlineSub() { return *cast(OnlineSubsystem*)(cast(size_t)cast(void*)this + 68); }
	public @property final auto ref float SearchStarted() { return *cast(float*)(cast(size_t)cast(void*)this + 64); }
	public @property final auto ref ubyte ControllerId() { return *cast(ubyte*)(cast(size_t)cast(void*)this + 60); }
	final bool Init(ubyte ControllerIndex, int GameMode)
	{
		ubyte params[9];
		params[] = 0;
	...
	final bool RequestJoin(OnlineGameSearch.OnlineGameSearchResult GameToJoin)
	{
		ubyte params[12];
		params[] = 0;
