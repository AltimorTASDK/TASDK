...
import UnrealScript.TribesGame.TrServerSettingsInfo;
...
extern(C++) interface TrGameReplicationInfo : UTGameReplicationInfo
{
	...
	public static immutable auto MIN_PLAYERS_FOR_PERF_BONUS = 6;
	public static immutable auto MIN_PLAYERS_FOR_PRIVATE_XP = 8;
	public @property final auto ref TrServerSettingsInfo r_ServerConfig() { return *cast(TrServerSettingsInfo*)(cast(size_t)cast(void*)this + 684); }
	public @property final auto ref TrPlayerReplicationInfo r_BEPlayerList() { return *cast(TrPlayerReplicationInfo*)(cast(size_t)cast(void*)this + 816); }
	public @property final auto ref TrPlayerReplicationInfo r_DSPlayerList() { return *cast(TrPlayerReplicationInfo*)(cast(size_t)cast(void*)this + 848); }
	public @property final auto ref int r_nRoundScore() { return *cast(int*)(cast(size_t)cast(void*)this + 764); }
	public @property final auto ref int r_nCurrentRound() { return *cast(int*)(cast(size_t)cast(void*)this + 772); }
	public @property final auto ref TrObjectPool m_TrObjectPool() { return *cast(TrObjectPool*)(cast(size_t)cast(void*)this + 636); }
	public @property final auto ref ScriptArray!(TrDeployable) m_Deployables() { return *cast(ScriptArray!(TrDeployable)*)(cast(size_t)cast(void*)this + 640); }
	public @property final auto ref TrPawn.PhysicsType r_PhysType() { return *cast(TrPawn.PhysicsType*)(cast(size_t)cast(void*)this + 711); }
	public @property final auto ref float m_fCurrentSensorBlipOpacity() { return *cast(float*)(cast(size_t)cast(void*)this + 724); }
	public @property final auto ref TrFlagBase m_Flags() { return *cast(TrFlagBase*)(cast(size_t)cast(void*)this + 676); }
	public @property final bool r_bSkiEnabled() { return (*cast(uint*)(cast(size_t)cast(void*)this + 704) & 0x10) != 0; }
	public @property final bool r_bSkiEnabled(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 704) |= 0x10; } else { *cast(uint*)(cast(size_t)cast(void*)this + 704) &= ~0x10; } return val; }
	public @property final auto ref int r_nNumCapturePointsHeld() { return *cast(int*)(cast(size_t)cast(void*)this + 808); }
	public @property final auto ref int GeneratorPower() { return *cast(int*)(cast(size_t)cast(void*)this + 688); }
	public @property final bool r_bPoweredCallins() { return (*cast(uint*)(cast(size_t)cast(void*)this + 704) & 0x2) != 0; }
	public @property final bool r_bPoweredCallins(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 704) |= 0x2; } else { *cast(uint*)(cast(size_t)cast(void*)this + 704) &= ~0x2; } return val; }
	public @property final auto ref PlayerReplicationInfo m_CurrentRabbitPRI() { return *cast(PlayerReplicationInfo*)(cast(size_t)cast(void*)this + 664); }
	public @property final auto ref TrDaDCore r_DaDCore() { return *cast(TrDaDCore*)(cast(size_t)cast(void*)this + 776); }
	public @property final auto ref TrDaDCapacitor r_DaDCapacitorBE() { return *cast(TrDaDCapacitor*)(cast(size_t)cast(void*)this + 784); }
	public @property final auto ref TrDaDCapacitor r_DaDCapacitorDS() { return *cast(TrDaDCapacitor*)(cast(size_t)cast(void*)this + 796); }
	public @property final auto ref int FlagReturnTime() { return *cast(int*)(cast(size_t)cast(void*)this + 668); }
	public @property final auto ref PlayerReplicationInfo m_RabbitLeaderBoard() { return *cast(PlayerReplicationInfo*)(cast(size_t)cast(void*)this + 652); }
	public @property final auto ref int r_CarrierCoreHealth() { return *cast(int*)(cast(size_t)cast(void*)this + 756); }
	public @property final auto ref int r_CarrierShieldHealth() { return *cast(int*)(cast(size_t)cast(void*)this + 748); }
	public @property final auto ref ScriptArray!(TrTeamBlockerStaticMeshActor) m_TeamBlockerCache() { return *cast(ScriptArray!(TrTeamBlockerStaticMeshActor)*)(cast(size_t)cast(void*)this + 712); }
	public @property final auto ref float r_fGlobalMaxJetpackThrustSpeedMultiplier() { return *cast(float*)(cast(size_t)cast(void*)this + 744); }
	public @property final auto ref float r_fGlobalAirSpeedMultiplier() { return *cast(float*)(cast(size_t)cast(void*)this + 740); }
	public @property final auto ref float r_fGlobalAccelerationMultiplier() { return *cast(float*)(cast(size_t)cast(void*)this + 736); }
	public @property final auto ref float r_fGlobalSpeedCapMultiplier() { return *cast(float*)(cast(size_t)cast(void*)this + 732); }
	public @property final auto ref float m_fSensorBlipFadeSpeed() { return *cast(float*)(cast(size_t)cast(void*)this + 728); }
	public @property final auto ref ubyte r_nBlip() { return *cast(ubyte*)(cast(size_t)cast(void*)this + 710); }
	public @property final auto ref ubyte r_nPhase0SeigeEnded() { return *cast(ubyte*)(cast(size_t)cast(void*)this + 709); }
	public @property final auto ref ubyte r_ResetGame() { return *cast(ubyte*)(cast(size_t)cast(void*)this + 708); }
	public @property final bool bGivePerfBonus() { return (*cast(uint*)(cast(size_t)cast(void*)this + 704) & 0x8) != 0; }
	public @property final bool bGivePerfBonus(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 704) |= 0x8; } else { *cast(uint*)(cast(size_t)cast(void*)this + 704) &= ~0x8; } return val; }
	public @property final bool bGivePrivateXP() { return (*cast(uint*)(cast(size_t)cast(void*)this + 704) & 0x4) != 0; }
	public @property final bool bGivePrivateXP(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 704) |= 0x4; } else { *cast(uint*)(cast(size_t)cast(void*)this + 704) &= ~0x4; } return val; }
	public @property final bool r_bCanPlaceDeployables() { return (*cast(uint*)(cast(size_t)cast(void*)this + 704) & 0x1) != 0; }
	public @property final bool r_bCanPlaceDeployables(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 704) |= 0x1; } else { *cast(uint*)(cast(size_t)cast(void*)this + 704) &= ~0x1; } return val; }
	public @property final auto ref int GeneratorDowntime() { return *cast(int*)(cast(size_t)cast(void*)this + 696); }
	final bool IsClassAllowed(int TeamNum, ScriptClass FamilyInfo)
	{
		ubyte params[12];
		params[] = 0;
	...
	final int GetTeamSize(ubyte TeamNum)
	{
		ubyte params[5];
		params[] = 0;
		params[0] = TeamNum;
	...
	final bool CanJoinTeam(ubyte RequestedTeam, ubyte CurrentTeam)
	{
		ubyte params[6];
		params[] = 0;
	...
	final float GetGlobalSpeedCapMultiplier()
	{
		ubyte params[4];
		params[] = 0;
	...
	final float GetGlobalAccelerationMultiplier()
	{
		ubyte params[4];
		params[] = 0;
	...
	final float GetGlobalAirSpeedMultiplier()
	{
		ubyte params[4];
		params[] = 0;
	...
	final float GetGlobalMaxJetpackThrustSpeedMultiplier()
	{
		ubyte params[4];
		params[] = 0;
	...
	final void CanPlaceDeployables(bool Value)
	{
		ubyte params[4];
		params[] = 0;
	...
	final void ChangePhysicsType(int Type)
	{
		ubyte params[4];
		params[] = 0;
	...
	final bool IsValidTeamPlayer(TrPlayerReplicationInfo TrPRI)
	{
		ubyte params[8];
		params[] = 0;
	...
	final void SetWarmingUp(bool bWarmup)
	{
		ubyte params[4];
		params[] = 0;
