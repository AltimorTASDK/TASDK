...
extern(C++) interface TrServerSettingsInfo : Info
{
	...
	public @property final bool bObjectiveUpgrades() { return (*cast(uint*)(cast(size_t)cast(void*)this + 524) & 0x4) != 0; }
	public @property final bool bObjectiveUpgrades(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 524) |= 0x4; } else { *cast(uint*)(cast(size_t)cast(void*)this + 524) &= ~0x4; } return val; }
	public @property final bool bPreplacedObjectives() { return (*cast(uint*)(cast(size_t)cast(void*)this + 524) & 0x20) != 0; }
	public @property final bool bPreplacedObjectives(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 524) |= 0x20; } else { *cast(uint*)(cast(size_t)cast(void*)this + 524) &= ~0x20; } return val; }
	public @property final bool bFriendlyFireDeployables() { return (*cast(uint*)(cast(size_t)cast(void*)this + 524) & 0x100) != 0; }
	public @property final bool bFriendlyFireDeployables(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 524) |= 0x100; } else { *cast(uint*)(cast(size_t)cast(void*)this + 524) &= ~0x100; } return val; }
	public @property final bool bPoweredDeployables() { return (*cast(uint*)(cast(size_t)cast(void*)this + 524) & 0x8) != 0; }
	public @property final bool bPoweredDeployables(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 524) |= 0x8; } else { *cast(uint*)(cast(size_t)cast(void*)this + 524) &= ~0x8; } return val; }
	public @property final bool bFriendlyFireBaseAssets() { return (*cast(uint*)(cast(size_t)cast(void*)this + 524) & 0x80) != 0; }
	public @property final bool bFriendlyFireBaseAssets(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 524) |= 0x80; } else { *cast(uint*)(cast(size_t)cast(void*)this + 524) &= ~0x80; } return val; }
	public @property final auto ref int BaseDestructionLimit() { return *cast(int*)(cast(size_t)cast(void*)this + 508); }
	public @property final auto ref int MaxSpeedWithFlagLight() { return *cast(int*)(cast(size_t)cast(void*)this + 692); }
	public @property final auto ref int MaxSpeedWithFlagMedium() { return *cast(int*)(cast(size_t)cast(void*)this + 684); }
	public @property final auto ref int MaxSpeedWithFlagHeavy() { return *cast(int*)(cast(size_t)cast(void*)this + 696); }
	public @property final auto ref int DecelerationRateWithFlag() { return *cast(int*)(cast(size_t)cast(void*)this + 688); }
	public @property final bool bSupplyDropAmmoOnly() { return (*cast(uint*)(cast(size_t)cast(void*)this + 524) & 0x200) != 0; }
	public @property final bool bSupplyDropAmmoOnly(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 524) |= 0x200; } else { *cast(uint*)(cast(size_t)cast(void*)this + 524) &= ~0x200; } return val; }
	public @property final auto ref float fEnergyMultiplier() { return *cast(float*)(cast(size_t)cast(void*)this + 672); }
	public @property final bool bTeamCredits() { return (*cast(uint*)(cast(size_t)cast(void*)this + 524) & 0x800) != 0; }
	public @property final bool bTeamCredits(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 524) |= 0x800; } else { *cast(uint*)(cast(size_t)cast(void*)this + 524) &= ~0x800; } return val; }
	public @property final auto ref int RespawnTime() { return *cast(int*)(cast(size_t)cast(void*)this + 496); }
	public @property final auto ref int TeamAssignType() { return *cast(int*)(cast(size_t)cast(void*)this + 504); }
	public @property final auto ref int VehiclePrices() { return *cast(int*)(cast(size_t)cast(void*)this + 604); }
	public @property final auto ref int FFKillLimit() { return *cast(int*)(cast(size_t)cast(void*)this + 512); }
	public @property final auto ref int FFDamageLimit() { return *cast(int*)(cast(size_t)cast(void*)this + 516); }
	public @property final auto ref int CallinPrices() { return *cast(int*)(cast(size_t)cast(void*)this + 628); }
	public @property final auto ref float CallinBuildups() { return *cast(float*)(cast(size_t)cast(void*)this + 652); }
	public @property final auto ref int CallinCooldowns() { return *cast(int*)(cast(size_t)cast(void*)this + 640); }
	public @property final auto ref int TimeLimit() { return *cast(int*)(cast(size_t)cast(void*)this + 476); }
	public @property final auto ref int OvertimeLimit() { return *cast(int*)(cast(size_t)cast(void*)this + 500); }
	public @property final auto ref int WarmupTime() { return *cast(int*)(cast(size_t)cast(void*)this + 480); }
	public @property final bool bAutoBalanceInGame() { return (*cast(uint*)(cast(size_t)cast(void*)this + 524) & 0x2) != 0; }
	public @property final bool bAutoBalanceInGame(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 524) |= 0x2; } else { *cast(uint*)(cast(size_t)cast(void*)this + 524) &= ~0x2; } return val; }
	public @property final auto ref float fFriendlyFireDamageMultiplier() { return *cast(float*)(cast(size_t)cast(void*)this + 664); }
	public @property final auto ref int ArenaRounds() { return *cast(int*)(cast(size_t)cast(void*)this + 492); }
	public @property final auto ref int GameScores() { return *cast(int*)(cast(size_t)cast(void*)this + 528); }
	public @property final bool bCTFBlitzAllFlagsMove() { return (*cast(uint*)(cast(size_t)cast(void*)this + 524) & 0x2000) != 0; }
	public @property final bool bCTFBlitzAllFlagsMove(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 524) |= 0x2000; } else { *cast(uint*)(cast(size_t)cast(void*)this + 524) &= ~0x2000; } return val; }
	public @property final bool bFriendlyFire() { return (*cast(uint*)(cast(size_t)cast(void*)this + 524) & 0x1) != 0; }
	public @property final bool bFriendlyFire(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 524) |= 0x1; } else { *cast(uint*)(cast(size_t)cast(void*)this + 524) &= ~0x1; } return val; }
	public @property final bool bPoweredCallins() { return (*cast(uint*)(cast(size_t)cast(void*)this + 524) & 0x400) != 0; }
	public @property final bool bPoweredCallins(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 524) |= 0x400; } else { *cast(uint*)(cast(size_t)cast(void*)this + 524) &= ~0x400; } return val; }
	public @property final bool bSkiEnabled() { return (*cast(uint*)(cast(size_t)cast(void*)this + 524) & 0x1000) != 0; }
	public @property final bool bSkiEnabled(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 524) |= 0x1000; } else { *cast(uint*)(cast(size_t)cast(void*)this + 524) &= ~0x1000; } return val; }
	public @property final auto ref int SpawnType() { return *cast(int*)(cast(size_t)cast(void*)this + 520); }
	public @property final bool bGeneratorAutoRegen() { return (*cast(uint*)(cast(size_t)cast(void*)this + 524) & 0x10) != 0; }
	public @property final bool bGeneratorAutoRegen(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 524) |= 0x10; } else { *cast(uint*)(cast(size_t)cast(void*)this + 524) &= ~0x10; } return val; }
	public @property final bool bGenDestroyable() { return (*cast(uint*)(cast(size_t)cast(void*)this + 524) & 0x40) != 0; }
	public @property final bool bGenDestroyable(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 524) |= 0x40; } else { *cast(uint*)(cast(size_t)cast(void*)this + 524) &= ~0x40; } return val; }
	public @property final auto ref float fAoEDamageMultiplier() { return *cast(float*)(cast(size_t)cast(void*)this + 680); }
	public @property final auto ref float fAoESizeMultiplier() { return *cast(float*)(cast(size_t)cast(void*)this + 676); }
	public @property final auto ref float fVehicleHealthMultiplier() { return *cast(float*)(cast(size_t)cast(void*)this + 668); }
	public @property final auto ref int CallinsDenied() { return *cast(int*)(cast(size_t)cast(void*)this + 624); }
	public @property final auto ref int VehicleLimits() { return *cast(int*)(cast(size_t)cast(void*)this + 584); }
	public @property final auto ref int ClassCounts() { return *cast(int*)(cast(size_t)cast(void*)this + 548); }
	public @property final auto ref int MaxPlayers() { return *cast(int*)(cast(size_t)cast(void*)this + 488); }
	public @property final auto ref int ScoreLimit() { return *cast(int*)(cast(size_t)cast(void*)this + 484); }
	final int GetClassCount(TrObject.TrClassType ClassType)
	{
		ubyte params[5];
		params[] = 0;
	...
	final bool IsCallinAllowed(int Index)
	{
		ubyte params[8];
		params[] = 0;
	...
	final bool IsClassAllowed(TrObject.TrClassType ClassType, int CurrentCount)
	{
		ubyte params[9];
		params[] = 0;
		*cast(TrObject.TrClassType*)params.ptr = ClassType;
	...
	final bool GetPropAsFloat(int PropId, float* Value)
	{
		ubyte params[12];
		params[] = 0;
	...
	final bool GetPropAsInt(int PropId, int* Value)
	{
		ubyte params[12];
		params[] = 0;
		*cast(int*)params.ptr = PropId;
	...
	final bool GetPropAsString(int PropId, ScriptString* Value)
	{
		ubyte params[20];
		params[] = 0;
		*cast(int*)params.ptr = PropId;
