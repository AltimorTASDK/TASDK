...
{
	public @property final bool r_bIsActive() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1128) & 0x1) != 0; }
	public @property final bool r_bIsActive(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1128) |= 0x1; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1128) &= ~0x1; } return val; }
	public @property final auto ref int CTFBlitzIndex() { return *cast(int*)(cast(size_t)cast(void*)this + 1124); }
	public @property final auto ref MaterialInstanceConstant m_MarkerMIC() { return *cast(MaterialInstanceConstant*)(cast(size_t)cast(void*)this + 1120); }
	public @property final auto ref TrAnimNodeBlendList m_OpenCloseBlendList() { return *cast(TrAnimNodeBlendList*)(cast(size_t)cast(void*)this + 1116); }
	...
	final void SetBlitzStandActive(bool bActive)
	{
		ubyte params[4];
		params[] = 0;
