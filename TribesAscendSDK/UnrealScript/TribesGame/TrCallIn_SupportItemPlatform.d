...
{
	public @property final auto ref TrGameObjective r_DeployedItem() { return *cast(TrGameObjective*)(cast(size_t)cast(void*)this + 476); }
	public @property final auto ref ubyte DefenderTeamIndex() { return *cast(ubyte*)(cast(size_t)cast(void*)this + 496); }
	public @property final auto ref ScriptName ItemAttachPointName() { return *cast(ScriptName*)(cast(size_t)cast(void*)this + 488); }
	...
	final void Init(Actor DeployableOwner, ScriptClass GameObjectiveClass)
	{
		ubyte params[8];
		params[] = 0;
