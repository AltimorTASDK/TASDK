...
extern(C++) interface TrGameObjective : UTGameObjective
{
	...
	{
		public @property final auto ref ScriptName PropertyName() { return *cast(ScriptName*)(cast(size_t)&this + 16); }
		private ubyte __PropertyName[8];
		public @property final auto ref float NewValue() { return *cast(float*)(cast(size_t)&this + 12); }
		private ubyte __NewValue[4];
		public @property final auto ref int UpgradeCreditCost() { return *cast(int*)(cast(size_t)&this + 8); }
		private ubyte __UpgradeCreditCost[4];
		public @property final auto ref int UpgradeLevel() { return *cast(int*)(cast(size_t)&this + 4); }
		private ubyte __UpgradeLevel[4];
		public @property final auto ref ScriptClass UpgradeClass() { return *cast(ScriptClass*)(cast(size_t)&this + 0); }
		private ubyte __UpgradeClass[4];
	}
	struct ObjectiveDamageAssist
	{
		public @property final auto ref int DamageAmount() { return *cast(int*)(cast(size_t)&this + 4); }
		private ubyte __DamageAmount[4];
		public @property final auto ref TrPlayerController Damager() { return *cast(TrPlayerController*)(cast(size_t)&this + 0); }
		private ubyte __Damager[4];
	}
	public @property final auto ref ScriptArray!(TrGameObjective.UpgradeSelectionList) m_UpgradeList() { return *cast(ScriptArray!(TrGameObjective.UpgradeSelectionList)*)(cast(size_t)cast(void*)this + 1260); }
	public @property final auto ref ScriptArray!(TrGameObjective.ObjectiveDamageAssist) DamageAssistList() { return *cast(ScriptArray!(TrGameObjective.ObjectiveDamageAssist)*)(cast(size_t)cast(void*)this + 1324); }
	public @property final auto ref ScriptArray!(TrPlayerController) m_Upgraders() { return *cast(ScriptArray!(TrPlayerController)*)(cast(size_t)cast(void*)this + 1348); }
	public @property final auto ref ScriptClass m_AssistAccolade() { return *cast(ScriptClass*)(cast(size_t)cast(void*)this + 1344); }
	public @property final auto ref float fUpgradeAssistTime() { return *cast(float*)(cast(size_t)cast(void*)this + 1340); }
	public @property final auto ref float m_fMarker2DDistance() { return *cast(float*)(cast(size_t)cast(void*)this + 1336); }
	public @property final auto ref float DESTROY_ASSIST_PERCENTAGE() { return *cast(float*)(cast(size_t)cast(void*)this + 1320); }
	public @property final auto ref float REPAIR_ASSIST_PERCENTAGE() { return *cast(float*)(cast(size_t)cast(void*)this + 1316); }
	public @property final auto ref float m_fInstigatorNamePlacementY() { return *cast(float*)(cast(size_t)cast(void*)this + 1312); }
	public @property final auto ref float m_fObjectiveNamePlacementY() { return *cast(float*)(cast(size_t)cast(void*)this + 1308); }
	public @property final auto ref float m_fObjectiveHealthBarHeight() { return *cast(float*)(cast(size_t)cast(void*)this + 1304); }
	public @property final auto ref float m_fObjectiveHealthBarWidth() { return *cast(float*)(cast(size_t)cast(void*)this + 1300); }
	public @property final auto ref float m_fObjectiveHealthBarPlacementY() { return *cast(float*)(cast(size_t)cast(void*)this + 1296); }
	public @property final auto ref float m_fObjectiveHealthBarPlacementX() { return *cast(float*)(cast(size_t)cast(void*)this + 1292); }
	public @property final auto ref MaterialInstanceConstant m_MarkerMIC() { return *cast(MaterialInstanceConstant*)(cast(size_t)cast(void*)this + 1288); }
	public @property final auto ref MaterialInstanceConstant m_HealthBarMIC() { return *cast(MaterialInstanceConstant*)(cast(size_t)cast(void*)this + 1284); }
	public @property final auto ref float m_fRepairBoost() { return *cast(float*)(cast(size_t)cast(void*)this + 1280); }
	public @property final auto ref ParticleSystem m_UpgradeTemplate() { return *cast(ParticleSystem*)(cast(size_t)cast(void*)this + 1276); }
	public @property final auto ref int r_nUpgradeLevel() { return *cast(int*)(cast(size_t)cast(void*)this + 1272); }
	public @property final auto ref int m_nPromptMessageSwitch() { return *cast(int*)(cast(size_t)cast(void*)this + 1256); }
	public @property final auto ref float m_fPromptMessageTime() { return *cast(float*)(cast(size_t)cast(void*)this + 1252); }
	public @property final auto ref float m_fRemainingSeekingTargetHUDZoomTime() { return *cast(float*)(cast(size_t)cast(void*)this + 1248); }
	public @property final auto ref Rotator m_rPotentialSeekingTargetHUDRotation() { return *cast(Rotator*)(cast(size_t)cast(void*)this + 1236); }
	public @property final auto ref float m_fRemainingPotentialSeekingTargetHUDZoomTime() { return *cast(float*)(cast(size_t)cast(void*)this + 1232); }
	public @property final auto ref TrObject.EMissileLock m_MissileLockStatus() { return *cast(TrObject.EMissileLock*)(cast(size_t)cast(void*)this + 1229); }
	public @property final auto ref ubyte r_bReset() { return *cast(ubyte*)(cast(size_t)cast(void*)this + 1228); }
	public @property final auto ref ParticleSystem DestroyedTemplate() { return *cast(ParticleSystem*)(cast(size_t)cast(void*)this + 1220); }
	public @property final auto ref float m_fLifeAfterDeathSecs() { return *cast(float*)(cast(size_t)cast(void*)this + 1212); }
	public @property final auto ref Controller m_LastDamager() { return *cast(Controller*)(cast(size_t)cast(void*)this + 1208); }
	public @property final auto ref SoundCue m_ExplosionSound() { return *cast(SoundCue*)(cast(size_t)cast(void*)this + 1192); }
	public @property final bool m_bAlwaysRelevantToSameTeam() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1184) & 0x8000) != 0; }
	public @property final bool m_bAlwaysRelevantToSameTeam(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1184) |= 0x8000; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1184) &= ~0x8000; } return val; }
	public @property final bool m_bHurtByFriendlyFire() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1184) & 0x4000) != 0; }
	public @property final bool m_bHurtByFriendlyFire(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1184) |= 0x4000; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1184) &= ~0x4000; } return val; }
	public @property final bool m_bDestroyable() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1184) & 0x2000) != 0; }
	public @property final bool m_bDestroyable(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1184) |= 0x2000; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1184) &= ~0x2000; } return val; }
	public @property final bool m_bShowObjectivesForcesMarker() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1184) & 0x1000) != 0; }
	public @property final bool m_bShowObjectivesForcesMarker(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1184) |= 0x1000; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1184) &= ~0x1000; } return val; }
	public @property final bool m_bIsRepairable() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1184) & 0x800) != 0; }
	public @property final bool m_bIsRepairable(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1184) |= 0x800; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1184) &= ~0x800; } return val; }
	public @property final bool m_bIsUpgradeable() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1184) & 0x400) != 0; }
	public @property final bool m_bIsUpgradeable(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1184) |= 0x400; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1184) &= ~0x400; } return val; }
	public @property final bool m_bHasPromptText() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1184) & 0x200) != 0; }
	public @property final bool m_bHasPromptText(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1184) |= 0x200; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1184) &= ~0x200; } return val; }
	public @property final bool r_bInDestroyedState() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1184) & 0x100) != 0; }
	public @property final bool r_bInDestroyedState(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1184) |= 0x100; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1184) &= ~0x100; } return val; }
	public @property final bool m_bIsRepairableAfterDeath() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1184) & 0x80) != 0; }
	public @property final bool m_bIsRepairableAfterDeath(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1184) |= 0x80; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1184) &= ~0x80; } return val; }
	public @property final bool m_bPostRenderForEnemy() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1184) & 0x40) != 0; }
	public @property final bool m_bPostRenderForEnemy(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1184) |= 0x40; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1184) &= ~0x40; } return val; }
	public @property final bool m_bVisibilityRequiredForEnemy() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1184) & 0x20) != 0; }
	public @property final bool m_bVisibilityRequiredForEnemy(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1184) |= 0x20; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1184) &= ~0x20; } return val; }
	public @property final bool m_bForceShowHUD() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1184) & 0x10) != 0; }
	public @property final bool m_bForceShowHUD(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1184) |= 0x10; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1184) &= ~0x10; } return val; }
	public @property final bool m_bReceivesPowerFromGenerator() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1184) & 0x8) != 0; }
	public @property final bool m_bReceivesPowerFromGenerator(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1184) |= 0x8; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1184) &= ~0x8; } return val; }
	public @property final bool r_bIsPowered() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1184) & 0x4) != 0; }
	public @property final bool r_bIsPowered(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1184) |= 0x4; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1184) &= ~0x4; } return val; }
	public @property final bool m_bInstantOnlineSound() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1184) & 0x2) != 0; }
	public @property final bool m_bInstantOnlineSound(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1184) |= 0x2; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1184) &= ~0x2; } return val; }
	public @property final bool m_bAutoPlayOnlineSound() { return (*cast(uint*)(cast(size_t)cast(void*)this + 1184) & 0x1) != 0; }
	public @property final bool m_bAutoPlayOnlineSound(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 1184) |= 0x1; } else { *cast(uint*)(cast(size_t)cast(void*)this + 1184) &= ~0x1; } return val; }
	public @property final auto ref PhysicsAsset m_OfflinePhysicsAsset() { return *cast(PhysicsAsset*)(cast(size_t)cast(void*)this + 1180); }
	public @property final auto ref PhysicsAsset m_OnlinePhysicsAsset() { return *cast(PhysicsAsset*)(cast(size_t)cast(void*)this + 1176); }
	public @property final auto ref ScriptClass m_ExplosionLightClass() { return *cast(ScriptClass*)(cast(size_t)cast(void*)this + 1172); }
	public @property final auto ref ScriptString m_sScreenName() { return *cast(ScriptString*)(cast(size_t)cast(void*)this + 1160); }
	public @property final auto ref float m_fOuterExplosionShakeRadius() { return *cast(float*)(cast(size_t)cast(void*)this + 1156); }
	public @property final auto ref float m_fInnerExplosionShakeRadius() { return *cast(float*)(cast(size_t)cast(void*)this + 1152); }
	public @property final auto ref CameraAnim m_ExplosionShake() { return *cast(CameraAnim*)(cast(size_t)cast(void*)this + 1148); }
	public @property final auto ref ParticleSystem m_ExplosionTemplate() { return *cast(ParticleSystem*)(cast(size_t)cast(void*)this + 1144); }
	public @property final auto ref float m_fShieldHitRemainingTime() { return *cast(float*)(cast(size_t)cast(void*)this + 1140); }
	public @property final auto ref float m_fShieldHitTargetTimeLength() { return *cast(float*)(cast(size_t)cast(void*)this + 1136); }
	public @property final auto ref float m_fShieldHitTargetScale() { return *cast(float*)(cast(size_t)cast(void*)this + 1132); }
	public @property final auto ref MaterialInstanceConstant m_ShieldMIC() { return *cast(MaterialInstanceConstant*)(cast(size_t)cast(void*)this + 1128); }
	public @property final auto ref float ShowHeaderUntil() { return *cast(float*)(cast(size_t)cast(void*)this + 1124); }
	public @property final auto ref int MarkerOffset() { return *cast(int*)(cast(size_t)cast(void*)this + 1120); }
	public @property final auto ref Texture2D m_ShieldNormalMap() { return *cast(Texture2D*)(cast(size_t)cast(void*)this + 1116); }
	public @property final auto ref Material m_ShieldMaterial() { return *cast(Material*)(cast(size_t)cast(void*)this + 1112); }
	public @property final auto ref float m_fShieldHealthPercentage() { return *cast(float*)(cast(size_t)cast(void*)this + 1104); }
	public @property final auto ref int r_nRepairHealthThreshold() { return *cast(int*)(cast(size_t)cast(void*)this + 1100); }
	public @property final auto ref int m_nCriticalHealthThreshold() { return *cast(int*)(cast(size_t)cast(void*)this + 1096); }
	public @property final auto ref Vector r_vReplicatedHitInfo() { return *cast(Vector*)(cast(size_t)cast(void*)this + 1084); }
	public @property final auto ref int m_nHealthRegenRate() { return *cast(int*)(cast(size_t)cast(void*)this + 1080); }
	public @property final auto ref int m_nLastHealth() { return *cast(int*)(cast(size_t)cast(void*)this + 1076); }
	public @property final auto ref int r_MaxHealth() { return *cast(int*)(cast(size_t)cast(void*)this + 1072); }
	public @property final auto ref int r_Health() { return *cast(int*)(cast(size_t)cast(void*)this + 1068); }
	public @property final auto ref MaterialInstanceConstant m_ObjectiveMIC() { return *cast(MaterialInstanceConstant*)(cast(size_t)cast(void*)this + 1064); }
	public @property final auto ref Vector CallInPosition() { return *cast(Vector*)(cast(size_t)cast(void*)this + 1044); }
	public @property final auto ref Rotator CallInRotation() { return *cast(Rotator*)(cast(size_t)cast(void*)this + 1032); }
	public @property final auto ref TrStatsInterface Stats() { return *cast(TrStatsInterface*)(cast(size_t)cast(void*)this + 1028); }
	...
	final bool IsInLOS_Basic(Pawn TouchedPawn)
	{
		ubyte params[8];
		params[] = 0;
	...
	final int GetUpgradeCost(TrPlayerController TrPC)
	{
		ubyte params[8];
		params[] = 0;
	...
	final bool ShouldShowPromptText(Pawn aPawn)
	{
		ubyte params[8];
		params[] = 0;
	...
	final bool PerformUpgrade(TrPlayerController Purchaser)
	{
		ubyte params[8];
		params[] = 0;
	...
	final void AddUpgrader(TrPlayerController Upgrader)
	{
		ubyte params[4];
		params[] = 0;
	...
	final void AddDamageAssistance(TrPlayerController TrPC, int DamageAmount)
	{
		ubyte params[8];
		params[] = 0;
		*cast(TrPlayerController*)params.ptr = TrPC;
