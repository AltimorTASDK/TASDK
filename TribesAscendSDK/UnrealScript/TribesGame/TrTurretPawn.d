...
{
	public @property final auto ref TrDeployable m_OwnerDeployable() { return *cast(TrDeployable*)(cast(size_t)cast(void*)this + 3192); }
	final Vector LeadingAimLocation(Actor Enemy)
	{
		ubyte params[16];
		params[] = 0;
	...
	final Vector GetValidAimTarget(Vector PawnLocation, Vector PawnTargetLocation)
	{
		ubyte params[36];
		params[] = 0;
	...
	final Vector GetAimVectorFor(Weapon InWeapon, Vector projStart, Actor Enemy)
	{
		ubyte params[32];
		params[] = 0;
		*cast(Weapon*)params.ptr = InWeapon;
