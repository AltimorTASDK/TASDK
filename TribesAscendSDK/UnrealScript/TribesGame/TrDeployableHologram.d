...
{
	public @property final auto ref int m_nOldInvalidDeployReason() { return *cast(int*)(cast(size_t)cast(void*)this + 544); }
	public @property final auto ref MaterialInstanceConstant m_RuntimeMIC() { return *cast(MaterialInstanceConstant*)(cast(size_t)cast(void*)this + 540); }
	public @property final auto ref MaterialInstanceConstant m_HologramMaterial() { return *cast(MaterialInstanceConstant*)(cast(size_t)cast(void*)this + 536); }
	final void SetValidDeployableLocation(bool bValidLocation, int InvalidDeployReason)
	{
		ubyte params[8];
		params[] = 0;
	...
	final void Init(ScriptClass DeployableClass)
	{
		ubyte params[4];
		params[] = 0;
