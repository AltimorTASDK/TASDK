...
extern(C++) interface GFxTrPage_Accolades : GFxTrPage
{
	...
	public @property final auto ref int AccoladeType() { return *cast(int*)(cast(size_t)cast(void*)this + 356); }
	...
	final GFxObject FillAccolade(TgPlayerProfile.AccoladeStruct Accolade)
	{
		ubyte params[20];
		params[] = 0;
	...
	final ScriptClass GetAccoladeClass(int AccoladeId)
	{
		ubyte params[8];
		params[] = 0;
