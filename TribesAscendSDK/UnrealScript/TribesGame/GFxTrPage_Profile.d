...
extern(C++) interface GFxTrPage_Profile : GFxTrPage
{
	...
	final int GetPlayedPercent(int ClassId, bool bResolve)
	{
		ubyte params[12];
		params[] = 0;
	...
	final ScriptString GetMostPlayed()
	{
		ubyte params[12];
		params[] = 0;
	...
	final ScriptString GetTimePlayed()
	{
		ubyte params[12];
		params[] = 0;
	...
	final ScriptString GetWinLossRatio()
	{
		ubyte params[12];
		params[] = 0;
	...
	final int GetAccoladeCount(int AccoladeId)
	{
		ubyte params[8];
		params[] = 0;
	...
	final int GetTopBadgeIcon(int Index)
	{
		ubyte params[8];
		params[] = 0;
	...
	final float GetFlagDefensesPerHour()
	{
		ubyte params[4];
		params[] = 0;
	...
	final float GetGensDestroyedPerHour()
	{
		ubyte params[4];
		params[] = 0;
	...
	final float GetObjsDestroyedPerHour()
	{
		ubyte params[4];
		params[] = 0;
