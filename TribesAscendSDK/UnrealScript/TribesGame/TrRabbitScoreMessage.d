...
extern(C++) interface TrRabbitScoreMessage : UTLocalMessage
{
	...
	public @property final auto ref SoundCue m_sFlagReturnedToStand() { return *cast(SoundCue*)(cast(size_t)cast(void*)this + 208); }
	public @property final auto ref SoundCue m_sYouPickedUpFlag() { return *cast(SoundCue*)(cast(size_t)cast(void*)this + 204); }
	public @property final auto ref SoundCue m_sOtherIsNewLeadeCue() { return *cast(SoundCue*)(cast(size_t)cast(void*)this + 200); }
	public @property final auto ref SoundCue m_sYouAreNewLeadeCue() { return *cast(SoundCue*)(cast(size_t)cast(void*)this + 196); }
	public @property final auto ref ScriptString GetToTheFlag() { return *cast(ScriptString*)(cast(size_t)cast(void*)this + 184); }
	public @property final auto ref ScriptString KillTheRabbit() { return *cast(ScriptString*)(cast(size_t)cast(void*)this + 172); }
	public @property final auto ref ScriptString OtherDroppedFlag() { return *cast(ScriptString*)(cast(size_t)cast(void*)this + 160); }
	public @property final auto ref ScriptString YouDroppedFlag() { return *cast(ScriptString*)(cast(size_t)cast(void*)this + 148); }
	public @property final auto ref ScriptString OtherIsNewLeader() { return *cast(ScriptString*)(cast(size_t)cast(void*)this + 136); }
	public @property final auto ref ScriptString YouAreNewLeader() { return *cast(ScriptString*)(cast(size_t)cast(void*)this + 124); }
	public @property final auto ref ScriptString OtherScoreFlagTouch() { return *cast(ScriptString*)(cast(size_t)cast(void*)this + 112); }
	public @property final auto ref ScriptString YouScoreFlagTouch() { return *cast(ScriptString*)(cast(size_t)cast(void*)this + 100); }
	final ScriptString GetString(int Switch, bool bPRI1HUD, PlayerReplicationInfo RelatedPRI_1, PlayerReplicationInfo RelatedPRI_2, UObject OptionalObject)
	{
		...
		*cast(UObject*)&params[16] = OptionalObject;
		(cast(ScriptObject)this).ProcessEvent(cast(ScriptFunction)(*ScriptObject.ObjectArray)[110330], params.ptr, cast(void*)0);
	...
	final void ClientReceive(PlayerController P, int Switch, PlayerReplicationInfo RelatedPRI_1, PlayerReplicationInfo RelatedPRI_2, UObject OptionalObject)
	{
		...
		*cast(PlayerReplicationInfo*)&params[12] = RelatedPRI_2;
		*cast(UObject*)&params[16] = OptionalObject;
		(cast(ScriptObject)this).ProcessEvent(cast(ScriptFunction)(*ScriptObject.ObjectArray)[110338], params.ptr, cast(void*)0);
	}
	final ubyte AnnouncementLevel(ubyte MessageIndex)
	{
		...
		(cast(ScriptObject)this).ProcessEvent(cast(ScriptFunction)(*ScriptObject.ObjectArray)[110346], params.ptr, cast(void*)0);
		return params[1];
	}
}
