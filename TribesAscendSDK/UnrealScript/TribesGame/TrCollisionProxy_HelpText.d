...
{
	public @property final auto ref TrHelpTextManager.EHelpTextType m_HelpTextType() { return *cast(TrHelpTextManager.EHelpTextType*)(cast(size_t)cast(void*)this + 496); }
	public @property final auto ref Pawn m_LocalPawn() { return *cast(Pawn*)(cast(size_t)cast(void*)this + 504); }
	public @property final auto ref float m_fHelpTextRemovalTime() { return *cast(float*)(cast(size_t)cast(void*)this + 500); }
	final bool ShouldShowHelpText_Delegate(TrHelpTextManager.EHelpTextType HelpTextType)
	{
		ubyte params[5];
		params[] = 0;
