...
{
	public @property final auto ref float GameSpeed() { return *cast(float*)(cast(size_t)cast(void*)this + 496); }
	final void InitMutator(ScriptString Options, ScriptString* ErrorMessage)
	{
		...
		*cast(ScriptString*)&params[12] = *ErrorMessage;
		(cast(ScriptObject)this).ProcessEvent(cast(ScriptFunction)(*ScriptObject.ObjectArray)[48632], params.ptr, cast(void*)0);
