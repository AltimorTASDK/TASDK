...
{
	final bool WriteOnlinePlayerScores(ScriptName SessionName, int LeaderboardId, ScriptArray!(OnlineSubsystem.OnlinePlayerScore)* PlayerScores)
	{
		ubyte params[28];
		params[] = 0;
	...
	final bool RegisterHostStatGuid(ScriptString* HostStatGuid)
	{
		ubyte params[16];
		params[] = 0;
	...
	final ScriptString GetClientStatGuid()
	{
		ubyte params[12];
		params[] = 0;
	...
	final bool RegisterStatGuid(OnlineSubsystem.UniqueNetId PlayerID, ScriptString* ClientStatGuid)
	{
		ubyte params[24];
		params[] = 0;
	...
	final ScriptString GetHostStatGuid()
	{
		ubyte params[12];
		params[] = 0;
	...
	final bool ReadOnlineStats(ScriptArray!(OnlineSubsystem.UniqueNetId)* Players, OnlineStatsRead StatsRead)
	{
		ubyte params[20];
		params[] = 0;
	...
	final bool ReadOnlineStatsForFriends(ubyte LocalUserNum, OnlineStatsRead StatsRead)
	{
		ubyte params[9];
		params[] = 0;
	...
	final bool ReadOnlineStatsByRank(OnlineStatsRead StatsRead, int StartIndex, int NumToRead)
	{
		ubyte params[16];
		params[] = 0;
	...
	final bool ReadOnlineStatsByRankAroundPlayer(ubyte LocalUserNum, OnlineStatsRead StatsRead, int NumRows)
	{
		ubyte params[13];
		params[] = 0;
		params[0] = LocalUserNum;
	...
	final void OnReadOnlineStatsComplete(bool bWasSuccessful)
	{
		ubyte params[4];
		params[] = 0;
	...
	final void OnFlushOnlineStatsComplete(ScriptName SessionName, bool bWasSuccessful)
	{
		ubyte params[12];
		params[] = 0;
		*cast(ScriptName*)params.ptr = SessionName;
	...
	final void AddReadOnlineStatsCompleteDelegate(
...
void**)params.ptr = ReadOnlineStatsCompleteDelegate;
	...
	final void ClearReadOnlineStatsCompleteDelegate(
// ERROR: Unknown object class 'Class Core.DelegateProperty'~
void* ReadOnlineStatsCompleteDelegate)
	{
		ubyte params[12];
...
void**)params.ptr = ReadOnlineStatsCompleteDelegate;
	...
	final void FreeStats(OnlineStatsRead StatsRead)
	{
		ubyte params[4];
		params[] = 0;
		*cast(OnlineStatsRead*)params.ptr = StatsRead;
	...
	final bool WriteOnlineStats(ScriptName SessionName, OnlineSubsystem.UniqueNetId Player, OnlineStatsWrite StatsWrite)
	{
		ubyte params[24];
		params[] = 0;
		*cast(ScriptName*)params.ptr = SessionName;
		*cast(OnlineSubsystem.UniqueNetId*)&params[8] = Player;
	...
	final bool FlushOnlineStats(ScriptName SessionName)
	{
		ubyte params[12];
		params[] = 0;
		*cast(ScriptName*)params.ptr = SessionName;
	...
	final void AddFlushOnlineStatsCompleteDelegate(
// ERROR: Unknown object class 'Class Core.DelegateProperty'~
...
void**)params.ptr = FlushOnlineStatsCompleteDelegate;
	...
	final void ClearFlushOnlineStatsCompleteDelegate(
// ERROR: Unknown object class 'Class Core.DelegateProperty'~
void* FlushOnlineStatsCompleteDelegate)
	{
		ubyte params[12];
...
void**)params.ptr = FlushOnlineStatsCompleteDelegate;
	...
	final void AddRegisterHostStatGuidCompleteDelegate(
// ERROR: Unknown object class 'Class Core.DelegateProperty'~
...
void**)params.ptr = RegisterHostStatGuidCompleteDelegate;
	...
	final void ClearRegisterHostStatGuidCompleteDelegateDelegate(
// ERROR: Unknown object class 'Class Core.DelegateProperty'~
void* RegisterHostStatGuidCompleteDelegate)
	{
		ubyte params[12];
