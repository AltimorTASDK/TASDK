...
extern(C++) interface SpotLightToggleable : SpotLight
{
	...
	final void CreateCheckpointRecord(SpotLightToggleable.CheckpointRecord* Record)
	{
		ubyte params[4];
		params[] = 0;
	...
	final void ApplyCheckpointRecord(SpotLightToggleable.CheckpointRecord* Record)
	{
		ubyte params[4];
		params[] = 0;
		*cast(SpotLightToggleable.CheckpointRecord*)params.ptr = *Record;
