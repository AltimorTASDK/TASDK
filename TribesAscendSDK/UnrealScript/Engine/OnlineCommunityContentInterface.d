...
final:
	...
	bool ReadContentList(ubyte PlayerNum, int* StartAt = null, int* NumToRead = null)
	{
		ubyte params[16];
		params[] = 0;
		params[0] = PlayerNum;
	...
	void OnGetContentPayloadComplete(bool bWasSuccessful, OnlineSubsystem.CommunityContentFile FileDownloaded, ref in ScriptArray!(ubyte) Payload)
	{
		ubyte params[68];
		params[] = 0;
		*cast(bool*)params.ptr = bWasSuccessful;
		*cast(OnlineSubsystem.CommunityContentFile*)&params[4] = FileDownloaded;
		*cast(ScriptArray!(ubyte)*)&params[56] = cast(ScriptArray!(ubyte))Payload;
...
void**)params.ptr = ReadContentListCompleteDelegate;
	...
	bool ReadFriendsContentList(ubyte PlayerNum, ref in ScriptArray!(OnlineSubsystem.OnlineFriend) Friends, int* StartAt = null, int* NumToRead = null)
	{
		ubyte params[28];
		params[] = 0;
		params[0] = PlayerNum;
		*cast(ScriptArray!(OnlineSubsystem.OnlineFriend)*)&params[4] = cast(ScriptArray!(OnlineSubsystem.OnlineFriend))Friends;
		if (StartAt !is null)
...
void**)params.ptr = ReadFriendsContentListCompleteDelegate;
	...
	bool GetFriendsContentList(ubyte PlayerNum, ref in OnlineSubsystem.OnlineFriend Friend, ref ScriptArray!(OnlineSubsystem.CommunityContentFile) ContentFiles)
	{
		ubyte params[68];
		params[] = 0;
		params[0] = PlayerNum;
		*cast(OnlineSubsystem.OnlineFriend*)&params[4] = cast(OnlineSubsystem.OnlineFriend)Friend;
	...
	bool UploadContent(ubyte PlayerNum, ref in ScriptArray!(ubyte) Payload, ref in OnlineSubsystem.CommunityContentMetadata pMetaData)
	{
		ubyte params[36];
		params[] = 0;
		params[0] = PlayerNum;
		*cast(ScriptArray!(ubyte)*)&params[4] = cast(ScriptArray!(ubyte))Payload;
		*cast(OnlineSubsystem.CommunityContentMetadata*)&params[16] = cast(OnlineSubsystem.CommunityContentMetadata)pMetaData;
...
void**)params.ptr = UploadContentCompleteDelegate;
	...
	bool DownloadContent(ubyte PlayerNum, ref in OnlineSubsystem.CommunityContentFile FileToDownload)
	{
		ubyte params[60];
		params[] = 0;
		params[0] = PlayerNum;
		*cast(OnlineSubsystem.CommunityContentFile*)&params[4] = cast(OnlineSubsystem.CommunityContentFile)FileToDownload;
...
void**)params.ptr = DownloadContentCompleteDelegate;
	...
	bool GetContentPayload(ubyte PlayerNum, ref in OnlineSubsystem.CommunityContentFile FileDownloaded)
	{
		ubyte params[60];
		params[] = 0;
		params[0] = PlayerNum;
		*cast(OnlineSubsystem.CommunityContentFile*)&params[4] = cast(OnlineSubsystem.CommunityContentFile)FileDownloaded;
...
void**)params.ptr = GetContentPayloadCompleteDelegate;
	...
	void RateContent(ubyte PlayerNum, ref in OnlineSubsystem.CommunityContentFile FileToRate, int NewRating)
	{
		ubyte params[60];
		params[] = 0;
		params[0] = PlayerNum;
		*cast(OnlineSubsystem.CommunityContentFile*)&params[4] = cast(OnlineSubsystem.CommunityContentFile)FileToRate;
