...
{
	public @property final auto ref CoverLink TestLink() { return *cast(CoverLink*)(cast(size_t)cast(void*)this + 80); }
	final void SameCoverLink(NavigationHandle NavHandle, CoverLink InLink)
	{
		ubyte params[8];
		params[] = 0;
