...
{
	public @property final auto ref ScriptArray!(UIDataProvider_MenuItem) DynamicProviders() { return *cast(ScriptArray!(UIDataProvider_MenuItem)*)(cast(size_t)cast(void*)this + 264); }
	public @property final auto ref UObject.MultiMap_Mirror OptionProviders() { return *cast(UObject.MultiMap_Mirror*)(cast(size_t)cast(void*)this + 204); }
	public @property final auto ref ScriptName CurrentGameSettingsTag() { return *cast(ScriptName*)(cast(size_t)cast(void*)this + 196); }
	...
	final void GetSet(ScriptName SetName, ScriptArray!(UIDataProvider_MenuItem)* OutProviders)
	{
		ubyte params[20];
		params[] = 0;
		*cast(ScriptName*)params.ptr = SetName;
	...
	final void OnGameSettingsChanged(UIDataProvider SourceProvider, ScriptName PropTag)
	{
		ubyte params[12];
		params[] = 0;
