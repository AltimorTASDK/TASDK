...
{
	public @property final auto ref ScriptClass ReachSpecClass() { return *cast(ScriptClass*)(cast(size_t)cast(void*)this + 84); }
	public @property final auto ref Vector InitLocation() { return *cast(Vector*)(cast(size_t)cast(void*)this + 72); }
	public @property final auto ref float MinDistBetweenSpecTypes() { return *cast(float*)(cast(size_t)cast(void*)this + 68); }
	final bool EnforceMinDist(Pawn P, float InMinDist, ScriptClass InSpecClass, Vector LastLocation)
	{
		ubyte params[28];
		params[] = 0;
