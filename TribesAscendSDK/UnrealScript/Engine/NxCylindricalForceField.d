...
extern(C++) interface NxCylindricalForceField : NxForceField
{
	...
	public @property final bool UseSpecialRadialForce() { return (*cast(uint*)(cast(size_t)cast(void*)this + 576) & 0x1) != 0; }
	public @property final bool UseSpecialRadialForce(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 576) |= 0x1; } else { *cast(uint*)(cast(size_t)cast(void*)this + 576) &= ~0x1; } return val; }
