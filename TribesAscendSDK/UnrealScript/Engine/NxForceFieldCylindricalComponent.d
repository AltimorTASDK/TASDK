...
{
	public @property final auto ref UObject.Pointer Kernel() { return *cast(UObject.Pointer*)(cast(size_t)cast(void*)this + 608); }
	public @property final bool UseSpecialRadialForce() { return (*cast(uint*)(cast(size_t)cast(void*)this + 604) & 0x1) != 0; }
	public @property final bool UseSpecialRadialForce(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 604) |= 0x1; } else { *cast(uint*)(cast(size_t)cast(void*)this + 604) &= ~0x1; } return val; }
