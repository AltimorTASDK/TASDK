...
{
	public @property final auto ref ScriptArray!(int) EventIDFilter() { return *cast(ScriptArray!(int)*)(cast(size_t)cast(void*)this + 60); }
	public @property final auto ref ScriptArray!(GameplayEvents.GameStatGroup) GroupFilter() { return *cast(ScriptArray!(GameplayEvents.GameStatGroup)*)(cast(size_t)cast(void*)this + 72); }
	public @property final auto ref GameplayEventsReader Reader() { return *cast(GameplayEventsReader*)(cast(size_t)cast(void*)this + 84); }
	final void SetReader(GameplayEventsReader NewReader)
	{
		ubyte params[4];
		params[] = 0;
	...
	final void RemoveFilter(int EventID)
	{
		ubyte params[4];
		params[] = 0;
		*cast(int*)params.ptr = EventID;
	...
	final bool IsEventFiltered(int EventID)
	{
		ubyte params[8];
		params[] = 0;
		*cast(int*)params.ptr = EventID;
