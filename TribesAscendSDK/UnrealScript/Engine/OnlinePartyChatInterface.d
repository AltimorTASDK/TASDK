...
{
	final bool SendPartyGameInvites(ubyte LocalUserNum)
	{
		ubyte params[5];
		params[] = 0;
	...
	final void OnSendPartyGameInvitesComplete(bool bWasSuccessful)
	{
		ubyte params[4];
		params[] = 0;
	...
	final void AddSendPartyGameInvitesCompleteDelegate(ubyte LocalUserNum, 
...
void**)&params[4] = SendPartyGameInvitesCompleteDelegate;
	...
	final void ClearSendPartyGameInvitesCompleteDelegate(ubyte LocalUserNum, 
// ERROR: Unknown object class 'Class Core.DelegateProperty'~
void* SendPartyGameInvitesCompleteDelegate)
	{
		ubyte params[13];
...
void**)&params[4] = SendPartyGameInvitesCompleteDelegate;
	...
	final bool GetPartyMembersInformation(ScriptArray!(OnlineSubsystem.OnlinePartyMember)* PartyMembers)
	{
		ubyte params[16];
		params[] = 0;
	...
	final bool GetPartyMemberInformation(OnlineSubsystem.UniqueNetId MemberId, OnlineSubsystem.OnlinePartyMember* PartyMember)
	{
		ubyte params[68];
		params[] = 0;
	...
	final void AddPartyMemberListChangedDelegate(ubyte LocalUserNum, 
// ERROR: Unknown object class 'Class Core.DelegateProperty'~
...
void**)&params[4] = PartyMemberListChangedDelegate;
	...
	final void ClearPartyMemberListChangedDelegate(ubyte LocalUserNum, 
// ERROR: Unknown object class 'Class Core.DelegateProperty'~
void* PartyMemberListChangedDelegate)
	{
		ubyte params[13];
...
void**)&params[4] = PartyMemberListChangedDelegate;
	...
	final void AddPartyMembersInfoChangedDelegate(ubyte LocalUserNum, 
// ERROR: Unknown object class 'Class Core.DelegateProperty'~
...
void**)&params[4] = PartyMembersInfoChangedDelegate;
	...
	final void ClearPartyMembersInfoChangedDelegate(ubyte LocalUserNum, 
// ERROR: Unknown object class 'Class Core.DelegateProperty'~
void* PartyMembersInfoChangedDelegate)
	{
		ubyte params[13];
...
void**)&params[4] = PartyMembersInfoChangedDelegate;
	...
	final bool SetPartyMemberCustomData(ubyte LocalUserNum, int Data1, int Data2, int Data3, int Data4)
	{
		ubyte params[21];
		params[] = 0;
		params[0] = LocalUserNum;
	...
	final bool ShowPartyUI(ubyte LocalUserNum)
	{
		ubyte params[5];
		params[] = 0;
		params[0] = LocalUserNum;
	...
	final bool ShowVoiceChannelUI(ubyte LocalUserNum)
	{
		ubyte params[5];
		params[] = 0;
		params[0] = LocalUserNum;
	...
	final bool ShowCommunitySessionsUI(ubyte LocalUserNum)
	{
		ubyte params[5];
		params[] = 0;
		params[0] = LocalUserNum;
	...
	final bool IsInPartyChat(ubyte LocalUserNum)
	{
		ubyte params[5];
		params[] = 0;
		params[0] = LocalUserNum;
