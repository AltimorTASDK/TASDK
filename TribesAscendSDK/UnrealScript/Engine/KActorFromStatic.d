...
{
	public @property final auto ref float MaxImpulseSpeed() { return *cast(float*)(cast(size_t)cast(void*)this + 716); }
	public @property final auto ref Actor MyStaticMeshActor() { return *cast(Actor*)(cast(size_t)cast(void*)this + 712); }
	final KActorFromStatic MakeDynamic(
...
void**)params.ptr = MovableMesh;
	...
	final void DisablePrecomputedLighting()
	{
	...
	final void ReceiveImpulse(Pawn Other, Vector HitLocation, Vector HitNormal)
	{
		ubyte params[28];
		params[] = 0;
