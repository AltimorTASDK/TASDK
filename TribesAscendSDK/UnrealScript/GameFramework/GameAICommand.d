...
{
	public @property final bool bPendingPop() { return (*cast(uint*)(cast(size_t)cast(void*)this + 84) & 0x20) != 0; }
	public @property final bool bPendingPop(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 84) |= 0x20; } else { *cast(uint*)(cast(size_t)cast(void*)this + 84) &= ~0x20; } return val; }
	public @property final bool bIgnoreStepAside() { return (*cast(uint*)(cast(size_t)cast(void*)this + 84) & 0x10) != 0; }
	public @property final bool bIgnoreStepAside(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 84) |= 0x10; } else { *cast(uint*)(cast(size_t)cast(void*)this + 84) &= ~0x10; } return val; }
	public @property final bool bIgnoreNotifies() { return (*cast(uint*)(cast(size_t)cast(void*)this + 84) & 0x8) != 0; }
	public @property final bool bIgnoreNotifies(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 84) |= 0x8; } else { *cast(uint*)(cast(size_t)cast(void*)this + 84) &= ~0x8; } return val; }
	public @property final bool bAborted() { return (*cast(uint*)(cast(size_t)cast(void*)this + 84) & 0x4) != 0; }
	public @property final bool bAborted(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 84) |= 0x4; } else { *cast(uint*)(cast(size_t)cast(void*)this + 84) &= ~0x4; } return val; }
	public @property final bool bReplaceActiveSameClassInstance() { return (*cast(uint*)(cast(size_t)cast(void*)this + 84) & 0x2) != 0; }
	public @property final bool bReplaceActiveSameClassInstance(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 84) |= 0x2; } else { *cast(uint*)(cast(size_t)cast(void*)this + 84) &= ~0x2; } return val; }
	public @property final bool bAllowNewSameClassInstance() { return (*cast(uint*)(cast(size_t)cast(void*)this + 84) & 0x1) != 0; }
	public @property final bool bAllowNewSameClassInstance(bool val) { if (val) { *cast(uint*)(cast(size_t)cast(void*)this + 84) |= 0x1; } else { *cast(uint*)(cast(size_t)cast(void*)this + 84) &= ~0x1; } return val; }
	public @property final auto ref ScriptName Status() { return *cast(ScriptName*)(cast(size_t)cast(void*)this + 76); }
	public @property final auto ref GameAIController GameAIOwner() { return *cast(GameAIController*)(cast(size_t)cast(void*)this + 72); }
	public @property final auto ref ScriptName ChildStatus() { return *cast(ScriptName*)(cast(size_t)cast(void*)this + 64); }
	public @property final auto ref GameAICommand ChildCommand() { return *cast(GameAICommand*)(cast(size_t)cast(void*)this + 60); }
	final bool InitCommandUserActor(GameAIController AI, Actor UserActor)
	{
		ubyte params[12];
		params[] = 0;
	...
	final bool InitCommand(GameAIController AI)
	{
		ubyte params[8];
		params[] = 0;
		*cast(GameAIController*)params.ptr = AI;
	...
	final void InternalPrePushed(GameAIController AI)
	{
		ubyte params[4];
		params[] = 0;
		*cast(GameAIController*)params.ptr = AI;
	...
	final void InternalResumed(ScriptName OldCommandName)
	{
		ubyte params[8];
		params[] = 0;
	...
	final void InternalTick(float DeltaTime)
	{
		ubyte params[4];
		params[] = 0;
	...
	final bool ShouldIgnoreNotifies()
	{
		ubyte params[4];
		params[] = 0;
	...
	final bool AllowTransitionTo(ScriptClass AttemptCommand)
	{
		ubyte params[8];
		params[] = 0;
	...
	final bool AllowStateTransitionTo(ScriptName StateName)
	{
		ubyte params[12];
		params[] = 0;
	...
	final void PrePushed(GameAIController AI)
	{
		ubyte params[4];
		params[] = 0;
		*cast(GameAIController*)params.ptr = AI;
	...
	final void Paused(GameAICommand NewCommand)
	{
		ubyte params[4];
		params[] = 0;
		*cast(GameAICommand*)params.ptr = NewCommand;
	...
	final void Resumed(ScriptName OldCommandName)
	{
		ubyte params[8];
		params[] = 0;
		*cast(ScriptName*)params.ptr = OldCommandName;
	...
	final void GetDebugOverheadText(PlayerController PC, ScriptArray!(ScriptString)* OutText)
	{
		ubyte params[16];
		params[] = 0;
	...
	final ScriptString GetDebugVerboseText()
	{
		ubyte params[12];
		params[] = 0;
