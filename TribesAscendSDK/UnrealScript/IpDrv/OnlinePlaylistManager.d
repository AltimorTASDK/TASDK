...
final:
	...
	void ParsePlaylistPopulationData(ref in ScriptArray!(ubyte) Data)
	{
		ubyte params[12];
		params[] = 0;
		*cast(ScriptArray!(ubyte)*)params.ptr = cast(ScriptArray!(ubyte))Data;
	...
	void ParseDataCenterId(ref in ScriptArray!(ubyte) Data)
	{
		ubyte params[12];
		params[] = 0;
		*cast(ScriptArray!(ubyte)*)params.ptr = cast(ScriptArray!(ubyte))Data;
