...
final:
	void OnCreateNewSessionRequestReceived(ScriptName SessionName, ScriptClass SearchClass, ref const ScriptArray!(MeshBeacon.PlayerMember) Players)
	{
		ubyte params[24];
		params[] = 0;
	...
	void OnTravelRequestReceived(ScriptName SessionName, ScriptClass SearchClass, ref const ubyte PlatformSpecificInfo)
	{
		ubyte params[92];
		params[] = 0;
		*cast(ScriptName*)params.ptr = SessionName;
	...
	void OnReceivedBandwidthTestResults(MeshBeacon.EMeshBeaconBandwidthTestType TestType, MeshBeacon.EMeshBeaconBandwidthTestResult TestResult, ref const MeshBeacon.ConnectionBandwidthStats BandwidthStats)
	{
		ubyte params[16];
		params[] = 0;
	...
	bool RequestConnection(ref const OnlineGameSearch.OnlineGameSearchResult DesiredHost, ref const MeshBeaconClient.ClientConnectionRequest ClientRequest, bool bRegisterSecureAddress)
	{
		ubyte params[52];
		params[] = 0;
	...
	bool SendHostNewGameSessionResponse(bool bSuccess, ScriptName SessionName, ScriptClass SearchClass, ref const ubyte PlatformSpecificInfo)
	{
		ubyte params[100];
		params[] = 0;
