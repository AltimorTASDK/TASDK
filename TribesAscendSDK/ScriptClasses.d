...
public:
	@property
	{
		...
		final auto ref ushort NumParams() { return *cast(ushort*)(cast(size_t)cast(void*)this + 0xA0); }													// 0xA0 (0x04)
		final auto ref ushort ParamsSize() { return *cast(ushort*)(cast(size_t)cast(void*)this + 0xA4); }													// 0xA4 (0x04)
		final auto ref uint ReturnValOffset() { return *cast(uint*)(cast(size_t)cast(void*)this + 0xA8); }													// 0xA8 (0x04)
		// __padding__ 0xAC (0x04)
		final auto ref void* Function() { return *cast(void**)(cast(size_t)cast(void*)this + 0xB0); }														// 0xB0 (0x04)
	}
}
